...
The project includes 199 Worker/unit/integration/contract/security tests, 8 UI tests, 9 Playwright flows, a Chromium WebMCP compatibility smoke, a deterministic ten-case agent trace scorer, and a successful live WebMCP agent evaluation in Chrome Canary.
