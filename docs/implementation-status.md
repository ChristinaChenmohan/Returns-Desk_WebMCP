...
- Production D1 is provisioned and its checked-in binding passes a production deploy dry-run. Remote migrations, the signing secret, live deployment, and native target-Chrome/ChatGPT manual acceptance remain release gates; no deployed URL or real in-app trace is claimed.
