...
- Production D1 is provisioned and its checked-in binding passes a production deploy dry-run. Remote migrations, the signing secret, and live deployment remain release gates. Live WebMCP agent acceptance was completed in Chrome Canary.
- Wrangler reports no authenticated Cloudflare account. Production D1 provisioning and deployment have not been performed.
